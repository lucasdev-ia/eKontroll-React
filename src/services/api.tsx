...
const consultaEventosPorData = async (data) => {
  const url = `http://192.168.25.83:3000/eventos/consulta?mes=${data}`;
  try {
    const response = await fetch(url, {
      method: "GET",
      headers: {
...
export { consultaEventosPorData,listarEmpresas, processData, consultaCalendario, consultaAniversario, consultaEventos, consultaCalendarioSocio, consultaAniversarioSocio };